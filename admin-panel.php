...
<div class="jumbotron" style="border-radius:0;background:url('images/10.jpg');background-size:cover;height:400px;"></div> 
...
<a href="trainer.php" class="list-group-item active">Trainer details</a>             <a href="addtrainer.php" class="list-group-item active">Add new Trainer</a>
     ...
     <div class="card-body" style="background-color:#3498DB;color:FFFFFF;">
                ...
                <label>Trainer:</label> 
                <select class="form-control" name="tran_id">
